...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        $pdo = new PDO('mysql:host=localhost:33006;dbname=EMPRESA', "root", "dbrootpass");
    ...
    <form action="consultas.php" method="post">
        ...
        <select name="dni" id="dni">
            ...
            try {
                ...
                // Obtiene las poblaciones de la base de datos
                $dnis = $pdo->query("select dni from cliente")->fetchAll(PDO::FETCH_ASSOC);
        ...
        <select name="poblacion" id="poblacion">
            ...
            try {
                ...
                // Obtiene las poblaciones de la base de datos
                $poblaciones = $pdo->query("select distinct poblacion from cliente")->fetchAll(PDO::FETCH_ASSOC);
        ...
        <select name="proveedor" id="proveedor">
            ...
            try {
                ...
                $proveedores = $pdo->query("select nombre, nif from proveedor")->fetchAll(PDO::FETCH_ASSOC);
        ...
        <select name="producto" id="producto">
            ...
            try {
                ...
                $productos = $pdo->query("select cod_prod from producto")->fetchAll(PDO::FETCH_ASSOC);
